...
export default function Sidebar() {
    ...
    return (
        <div className="w-[100px] border-r border-t-0 border-slate-600 lg:col-span-1 md:w-full bg-gray-800">
            <div className="h-[65px] text-center text-white p-4 border-b border-slate-600 flex md:justify-end justify-center">
                <svg
